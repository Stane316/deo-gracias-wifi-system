...
- Attendu : 272/272 avec base (backend 175 dont 45 d'intégration + 5 modes démo
  + 4 validation env, shared 45, connector 46, frontend 6). Sans base : les
  intégrations pg skippent proprement.
